...
Usage:
    ...
    python book_validator.py books/alice_adventures/alice.md

    # Validate with auto-fix
    python book_validator.py book.md --auto-fix

    # Validate all books in directory
    python book_validator.py books/ --recursive

    # Require specific features
    python book_validator.py book.md --require karaoke,ai
...
def generate_auto_fixes(
    ...
    if text_metrics.get('has_gutenberg_boilerplate', False):
        fixes.append(f"Run: python gutenberg_extractor.py {file_path}")
