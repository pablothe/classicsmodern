...
BOOK_PROMPTS = {
    ...
    'jekyll': 'watercolor illustration, Victorian London duality, split face light and shadow, Gothic horror, mysterious laboratory, bubbling potion, dark cobblestone streets, gaslight atmosphere, Dr Jekyll and Mr Hyde transformation, deep greens and purples, psychological thriller, professional book cover',
    'little_women': 'watercolor illustration, four sisters in 19th century New England, cozy hearth scene, Civil War era, warm family bonds, Victorian dresses, soft golden light, domestic warmth, Louisa May Alcott, gentle pastoral American setting, professional book cover',
}
